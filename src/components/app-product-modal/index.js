...
import ProductIconLarge from '../../assets/img/product-img/product-pre-large.png'
      ...
      <div className="popup-window">
        ...
        <div className="row">
          <div className="product-prev col-12 col-xl-6">
            <img className="product-prev-focus" src={ProductIconLarge} alt=""/>
          ...
          <div className="product-desc col-12 col-xl-6">
            ...
            <h3 className="weight-medium text-theme-color text-size-24 mb-3">Gents Blue Lightweight Trainers</h3>
            ...
            <div className="d-flex align-items-center mb-3">
              <span className="weight-medium text-theme-color text-size-24">$190.00</span>
            ...
            <p className="my-3">Category: <span className="text-theme-color">Shoes</span></p>
            <p>Tags: 
